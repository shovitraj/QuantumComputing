 ...
 */
    ...
    __pyx_v_pos = ((((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_x.data) + __pyx_t_10)) ))) - __pyx_v_a) / __pyx_v_h) + 2.0);
 ...
 */
        ...
        *__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_out.diminfo[0].strides) += ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_c.data) + __pyx_t_15)) ))) * __pyx_v__tmp);
 ...
 */
        ...
        *__Pyx_BufPtrCContig1d(__pyx_t_double_complex *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_out.diminfo[0].strides) = __Pyx_c_sum_double((*__Pyx_BufPtrCContig1d(__pyx_t_double_complex *, __pyx_pybuffernd_out.rcbuffer->pybuffer.buf, __pyx_t_15, __pyx_pybuffernd_out.diminfo[0].strides)), __Pyx_c_prod_double((*((__pyx_t_double_complex *) ( /* dim=0 */ ((char *) (((__pyx_t_double_complex *) __pyx_v_c.data) + __pyx_t_16)) ))), __pyx_t_double_complex_from_parts(__pyx_v__tmp, 0)));
